...
const AboutClientPage: React.FC<AboutClientPageProps> = ({
  isMobile = false,
}) => {
  return (
    <div
    ...
    >
      ...
      <div className="flex flex-col justify-center items-center w-full">
        {!isMobile ? (
          <div className="max-w-[1200px] grid grid-cols-[.6fr_1fr_.6fr] grid-rows-auto auto-cols-[1fr] place-items-center gap-[50px] w-full">
            ...
            <div className="flex flex-col justify-center items-start h-full gap-[25px] text-white">
              ...
              <div className="font-monigue text-[20px] tracking-[.04em] leading-5 ">
                ...
                &ldquo;oversized tees&rdquo; and a flood of imitation,
                streetwear was a voice for the unheard—a canvas for artists to
                channel the frustrations and truths of the people. While high
                fashion pandered to the elite, streetwear took the simplest of
                garments and used them to provoke thought and disrupt the status
                quo.
                <br />
                <br />
                ...
                thing you can do is wear your heart on your sleeve—literally.
                This is for the headstrong, the rebels, the misfits. Own your
                truth.
              </div>
              <Link href="/">
          ...
          <div className="w-full h-screen flex flex-col justify-center items-start p-5 gap-5">
            <div className="w-full flex h-[15%] justify-start">
              <img
                src={`${CONFIG.STATIC_IMGAE_ASSETS_URL}/combined-asset.png`}
                alt={"leftImage"}
            ...
            <div className="flex flex-col justify-center items-start h-auto gap-5 text-white">
              <h1 className="text-orange font-monigue text-[32px] tracking-[.04em]">
                about us
              </h1>
              <div className="font-monigue text-[16px] tracking-[.04em] leading-4 ">
                <span className="text-orange">Mohmaya</span> was born from a
                desire to reclaim streetwear’s origins. Before it became just
                &ldquo;oversized tees&rdquo; and a flood of imitation,
                streetwear was a voice for the unheard—a canvas for artists to
            ...
            <div className="w-full flex h-[15%] justify-end">
              <img
                src={`${CONFIG.STATIC_IMGAE_ASSETS_URL}/combined-asset.png`}
                alt={"leftImage"}
                className="h-full w-auto"
